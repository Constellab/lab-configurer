...
# Limit to version 28 due to imcopatibility of version 29 with Traefij : https://github.com/traefik/traefik/issues/12253
...
sudo apt-get -y install --allow-downgrades docker-ce=5:28.* docker-ce-cli=5:28.* containerd.io
